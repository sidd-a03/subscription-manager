...
export function SignUpForm({ className }: SignUpFormProps) {
  ...
  const { register, watch, handleSubmit, setError, formState: { errors } } = useForm<z.infer<typeof schema>>({
  ...
  const onSubmit: SubmitHandler<z.infer<typeof schema>> = async (data) => {
    try {
      const res = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/auth/sign-up`, {
